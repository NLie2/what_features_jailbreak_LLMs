...
from utils_finetune_Nathaliesettings import load_and_generate_responses_batched, grade_with_HF_batched
...
print("Running with apply_chat_template = ", apply_chat_template)
...
if os.path.exists(fname_stage1):
    ...
    df_val[f'output_text'] = load_and_generate_responses_batched(model_name, lora_weights_path, df_val['jailbreak_prompt_text'], batch_size=16, max_new_tokens=200)
